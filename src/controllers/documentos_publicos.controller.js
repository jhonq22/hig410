...
const subirArchivo = async (req, res) => {
  try {
    upload(req, res, async (err) => {
      ...
      const { estatus_id, nombre_documento, descripcion_documento, codigo_documento,  usuario_id,  } = req.body;
      ...
      const insertQuery = `
        ...
        (estatus_id, nombre_documento, descripcion_documento, codigo_documento, ruta_documento, fecha_registro)
        VALUES ($1, $2, $3, $4, $5, $6)
      `;
...
const listarDocumentos = async (req, res) => {
  try {
    ...
    const consulta = `
      SELECT dp.id, dp.descripcion_documento, dp.codigo_documento , dp.nombre_documento, dp.fecha_registro, dp.ruta_documento
